...
COMMENT ON COLUMN "public"."project"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."project"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."project"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."project"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."project"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."project"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."case_event"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."case_event"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."case_event"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."case_event"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."case_event"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."case_event"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."comment"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."comment"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."comment"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."comment"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."comment"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."comment"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."decision_element"."response_data" IS 'This jsonb field should contain the structure of data that will be returned by the logic engine - for example, if the response will be a json object containing a series of boolean yes/no indicators, this should specify the schema. ';



COMMENT ON COLUMN "public"."decision_element"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."decision_element"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."decision_element"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."decision_element"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."decision_element"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."decision_element"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."document"."document_files" IS 'This jsonb field should contain any document files if applicable; this is an optional way of storing or transmitting files and is not necessary as this is primarily a data record for metadata about the document rather than the document itself. ';



COMMENT ON COLUMN "public"."document"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."document"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."document"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."document"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."document"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."document"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."engagement"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."engagement"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."engagement"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."engagement"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."engagement"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."engagement"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."gis_data"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."gis_data"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."gis_data"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."gis_data"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."gis_data"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."gis_data"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."gis_data_element"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."gis_data_element"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."gis_data_element"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."gis_data_element"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."gis_data_element"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."gis_data_element"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."legal_structure"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."legal_structure"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."legal_structure"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."legal_structure"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."legal_structure"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."legal_structure"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."process_decision_payload"."data_annotation" IS 'Additional field for annotation related to payload';
...
COMMENT ON COLUMN "public"."process_decision_payload"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."process_decision_payload"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."process_decision_payload"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."process_decision_payload"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."process_decision_payload"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."process_decision_payload"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."process_instance"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."process_instance"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."process_instance"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."process_instance"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."process_instance"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."process_instance"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';



COMMENT ON COLUMN "public"."process_instance"."process_code" IS 'This is an optional field that can annotate the process instance with an agency''s internal reference for coding, such as a CE code.  ';
...
COMMENT ON COLUMN "public"."process_model"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."process_model"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."process_model"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."process_model"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."process_model"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."process_model"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
...
COMMENT ON COLUMN "public"."user_role"."record_owner_agency" IS 'This is the owner of the original data, generally the authoritative data source.';



COMMENT ON COLUMN "public"."user_role"."data_source_agency" IS 'This is the agency from which this data record was sent or retrieved or in which it is stored, which may be different than the record owner.';



COMMENT ON COLUMN "public"."user_role"."data_source_system" IS 'This is the system from which this data record was sent or retrieved or in which it is stored.';



COMMENT ON COLUMN "public"."user_role"."data_record_version" IS 'This is the version of this data record.';



COMMENT ON COLUMN "public"."user_role"."last_updated" IS 'This is the last update of the data record in the system.';



COMMENT ON COLUMN "public"."user_role"."retrieved_timestamp" IS 'This is the timestamp of a retrieval or transmission (e.g. responding to an API call).';
